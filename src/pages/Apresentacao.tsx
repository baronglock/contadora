...
/* ─── Label ─── */
const Label = ({ children, left }: { children: React.ReactNode; left?: boolean }) => (
  <p className={`text-[11px] font-semibold uppercase tracking-[0.2em] text-navy-400 mb-4 ${left ? "" : ""}`}>
    {children}
  </p>
);
...
export default function Apresentacao() {
  ...
  const refChatFeats = useReveal<HTMLDivElement>(0.15);
    ...
    <div className="min-h-screen bg-white text-navy-900 overflow-x-hidden">
      ...
      <nav
        className={`fixed top-0 inset-x-0 z-50 transition-all duration-500 ${
          scrolled
            ? "bg-white/80 backdrop-blur-2xl border-b border-navy-100/60 shadow-sm shadow-navy-900/[0.03]"
      ...
      >
        <div className="max-w-7xl mx-auto px-8 lg:px-16 h-16 flex items-center justify-between">
          ...
          {/* Mobile menu button */}
          <button
            className="md:hidden p-2 text-navy-500 hover:text-navy-800 transition-colors"
        ...
        >
          <div className="px-8 pb-6 pt-2 space-y-3 bg-white/95 backdrop-blur-xl border-b border-navy-100/60">
            {[
              ["#chatbot", "Chatbot"],
              ["#prospeccao", "Prospecção"],
              ["#bpo", "BPO Financeiro"],
      ...
      {/* ═══════ HERO ═══════ */}
      <section className="pt-44 pb-28 px-8 max-w-6xl mx-auto text-center hero-anim">
        <p className="text-[11px] font-semibold uppercase tracking-[0.25em] text-navy-300 mb-8">
          Proposta Técnica
        </p>

        <h1 className="font-display text-[40px] md:text-[52px] font-medium leading-[1.12] tracking-tight text-navy-950 max-w-[680px] mx-auto">
        ...
        <div className="mt-10">
          ...
          >
            Conhecer os módulos <ChevronRight size={15} className="transition-transform duration-300 group-hover:translate-x-1" />
          </a>
        </div>
      ...
      {/* ═══════ NÚMEROS ═══════ */}
      <section className="bg-navy-950 py-20 px-8">
        <div
          ref={refNums}
          className="max-w-6xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-y-10 gap-x-8 text-center reveal-children"
        >
          {[
      ...
      {/* ═══════ CHATBOT ═══════ */}
      <section id="chatbot" className="scroll-mt-20 py-28 px-8 max-w-6xl mx-auto">
        <div ref={refChat} className="reveal text-center">
          <Label>Módulo 01 — Chatbot IA</Label>

          <h2 className="font-display text-[30px] font-medium tracking-tight leading-snug max-w-xl mx-auto">
            Atendimento e qualificação automática de clientes
          </h2>

          <p className="text-[15px] text-navy-400 mt-4 max-w-lg mx-auto leading-relaxed font-light">
            Um agente de IA que conversa naturalmente via WhatsApp e no site —
            qualifica leads, tira dúvidas e agenda reuniões sem intervenção humana.
          </p>
        </div>

        {/* 2 cols: features + mockup */}
        <div className="mt-14 grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">

          {/* Features */}
          <div ref={refChatFeats} className="space-y-5 reveal-children">
            {[
              ...
              <div key={f.t} className="flex gap-4 group cursor-default">
                <div className="w-10 h-10 rounded-xl bg-navy-50 border border-navy-100 flex items-center justify-center flex-shrink-0 transition-all duration-300 group-hover:bg-navy-100 group-hover:scale-110">
            ...
            <div className="rounded-xl overflow-hidden bg-white border border-navy-100/60 shadow-sm">
              ...
              <div className="p-5 space-y-3 bg-[#f8f9fb] min-h-[300px]">
                {[
                  ...
                  >
                    <div
                      className={`max-w-[78%] px-4 py-2.5 text-[12.5px] leading-relaxed transition-shadow duration-300 hover:shadow-md ${
                        m.r === "u"
      ...
      {/* ═══════ PROSPECÇÃO ═══════ */}
      <section id="prospeccao" className="scroll-mt-20 py-28 px-8 max-w-6xl mx-auto">
        <div ref={refPipe} className="reveal text-center">
          <Label>Módulo 02 — Prospecção B2B</Label>

          <h2 className="font-display text-[30px] font-medium tracking-tight leading-snug max-w-xl mx-auto">
            Captura automatizada de empresas em toda a região de Curitiba
          </h2>

          <p className="text-[15px] text-navy-400 mt-4 max-w-lg mx-auto leading-relaxed font-light">
            Um motor que mapeia centenas de milhares de empresas usando dados oficiais
            e gratuitos da Receita Federal, filtra pelo perfil ideal e alimenta o chatbot.
          </p>
        </div>
        ...
        <div className="mt-16 grid grid-cols-2 md:grid-cols-5 gap-8">
          {[
            ...
            >
              <div className="w-12 h-12 mx-auto rounded-xl bg-navy-50 border border-navy-100 flex items-center justify-center mb-4 transition-all duration-400 group-hover:bg-navy-900 group-hover:border-navy-800 group-hover:shadow-lg group-hover:shadow-navy-900/15 group-hover:-translate-y-1">
                <s.icon size={20} className="text-navy-500 transition-colors duration-400 group-hover:text-white" strokeWidth={1.5} />
              </div>
        ...
        <div ref={refCidades} className="mt-16 p-8 rounded-2xl bg-navy-50/60 border border-navy-100 reveal text-center">
          ...
          <div className="flex flex-wrap justify-center gap-2.5">
            {[
              ...
              "Pinhais", "Campo Largo", "Fazenda Rio Grande",
              "Almirante Tamandaré", "Piraquara", "Campina Grande do Sul",
            ].map((c) => (
              <span
                key={c}
                className="px-4 py-2 rounded-lg bg-white text-[12px] text-navy-600 border border-navy-100 shadow-sm transition-all duration-300 hover:shadow-md hover:-translate-y-0.5 hover:border-navy-200 cursor-default"
              >
                {c}
              </span>
            ))}
            <span className="px-4 py-2 rounded-lg bg-white text-[12px] text-navy-300 border border-navy-100">
              + 19 municípios
            </span>
          </div>
        </div>
      ...
      {/* ═══════ BPO FINANCEIRO ═══════ */}
      <section id="bpo" className="scroll-mt-20 py-28 px-8 max-w-6xl mx-auto">
        <div ref={refBpo} className="reveal text-center">
          <Label>Módulo 03 — BPO Financeiro</Label>

          <h2 className="font-display text-[30px] font-medium tracking-tight leading-snug max-w-xl mx-auto">
            O dono da empresa foca em vendas.<br />A IA cuida do financeiro.
          </h2>

          <p className="text-[15px] text-navy-400 mt-4 max-w-lg mx-auto leading-relaxed font-light">
            Automação completa da rotina financeira — extração de documentos,
            categorização contábil, aprovações e conciliação bancária.
          </p>
        </div>

        {/* Flow — horizontal */}
        <div className="mt-16 p-8 rounded-2xl bg-navy-50/60 border border-navy-100">
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
            {[
              ...
              <div key={s.t} className="relative text-center group">
                <div className="w-12 h-12 mx-auto rounded-xl bg-white border border-navy-100 flex items-center justify-center mb-3 shadow-sm transition-all duration-400 group-hover:shadow-md group-hover:-translate-y-1 group-hover:border-navy-200">
                ...
                {i < 4 && (
                  <ArrowRight size={14} className="absolute top-6 -right-3 text-navy-200 hidden md:block" />
                )}
              </div>
            ))}
          </div>
      ...
      {/* ═══════ WEBSITE ═══════ */}
      <section id="website" className="scroll-mt-20 py-28 px-8 max-w-6xl mx-auto">
        <div ref={refWebsite} className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center reveal">

          {/* Text */}
          <div>
            <Label>Módulo 04 — Website</Label>

            <h2 className="font-display text-[30px] font-medium tracking-tight leading-snug">
              Presença digital profissional para o escritório
            </h2>

            <p className="text-[15px] text-navy-400 mt-4 leading-relaxed font-light">
              Site institucional moderno com o chatbot IA integrado.
              O primeiro ponto de contato de novos clientes.
            </p>
            ...
            <div className="mt-8 space-y-3.5">
              {[
                ...
                <div key={t} className="flex items-center gap-3 group cursor-default">
                  <div className="w-6 h-6 rounded-full bg-navy-50 border border-navy-100 flex items-center justify-center flex-shrink-0 transition-all duration-300 group-hover:bg-navy-900 group-hover:border-navy-800">
          ...
          <div className="rounded-2xl bg-navy-50/60 border border-navy-100 p-2.5 card-hover">
            <div className="rounded-xl overflow-hidden bg-white border border-navy-100/60 shadow-sm">
              ...
              <div className="px-8 py-10 text-center">
                <p className="font-display text-[20px] font-medium text-navy-900">
                ...
                <div className="mt-8 grid grid-cols-3 gap-3">
                  {["Contabilidade", "BPO Financeiro", "Consultoria"].map((s) => (
                    <div key={s} className="p-4 rounded-lg bg-navy-50 border border-navy-100/60 text-[10px] text-navy-500 font-medium transition-all duration-300 hover:bg-navy-100 hover:shadow-sm">
                      {s}
                    </div>
                  ))}
                </div>
      ...
      {/* ═══════ PLANOS ═══════ */}
      <section id="planos" className="scroll-mt-20 py-28 px-8 max-w-6xl mx-auto">
        <div className="text-center mb-16">
          <Label>Níveis de implementação</Label>
          <h2 className="font-display text-[30px] font-medium tracking-tight">
            Escolha o escopo ideal
          </h2>
          <p className="text-[15px] text-navy-400 mt-3 font-light">
            Cada módulo pode ser contratado separadamente ou em conjunto
          </p>
        </div>
        ...
        <div ref={refPlanos} className="grid grid-cols-1 lg:grid-cols-3 gap-6 reveal-children">
          {[
            {
              nome: "Essencial", sub: "Chatbot + Prospecção", dark: false,
              items: [
                ["Chatbot IA no WhatsApp", true],
                ["Widget de chat no site", true],
                ["Prospecção B2B automatizada", true],
                ["Pipeline de leads (CRM)", true],
                ["Disparo automático de mensagens", true],
                ["BPO Financeiro automatizado", false],
                ["Conciliação bancária", false],
                ["Website institucional", false],
              ],
            },
            {
              nome: "Completo", sub: "Chatbot + Prospecção + BPO", dark: true,
              items: [
                ["Chatbot IA no WhatsApp", true],
                ["Widget de chat no site", true],
                ["Prospecção B2B automatizada", true],
                ["Pipeline de leads (CRM)", true],
                ["Disparo automático de mensagens", true],
                ["BPO Financeiro automatizado", true],
                ["Conciliação bancária (Open Finance)", true],
                ["Website institucional", false],
              ],
            },
            {
              nome: "Premium", sub: "Solução completa + Website", dark: false,
              items: [
                ["Chatbot IA no WhatsApp", true],
                ["Widget de chat no site", true],
                ["Prospecção B2B automatizada", true],
                ...
                ["BPO Financeiro automatizado", true],
                ["Conciliação bancária (Open Finance)", true],
                ["Website institucional profissional", true],
              ],
            },
          ].map((p) => (
            <div
              ...
              className={`relative rounded-2xl p-8 border card-hover ${
                p.dark
                  ? "bg-navy-950 border-navy-800 shadow-xl shadow-navy-950/20"
            ...
            >
              ...
              <h3 className={`font-display text-[22px] font-medium ${p.dark ? "text-white" : "text-navy-900"}`}>
                {p.nome}
              </h3>
              <p className={`text-[12px] mt-1 mb-8 ${p.dark ? "text-navy-400" : "text-navy-400"}`}>
                {p.sub}
              </p>

              <div className="space-y-3">
                {p.items.map(([text, on]) => (
                  <div key={text as string} className={`flex items-center gap-3 transition-opacity duration-300 ${on ? "" : "opacity-25"}`}>
                    {on ? (
                      <Check size={15} className={p.dark ? "text-emerald-400 flex-shrink-0" : "text-navy-500 flex-shrink-0"} />
                    ) : (
                      <span className="w-[15px] flex-shrink-0 flex justify-center">
                        <span className={`block w-2.5 h-px ${p.dark ? "bg-navy-600" : "bg-navy-300"}`} />
                      </span>
                    )}
                    <span className={`text-[13px] ${
                      p.dark
                        ? on ? "text-navy-200" : "text-navy-600"
                        : on ? "text-navy-600" : "text-navy-300"
                    }`}>
                      {text as string}
                    </span>
                  </div>
      ...
      {/* ═══════ CRONOGRAMA ═══════ */}
      <section className="bg-navy-50/50 py-28 px-8">
        <div className="max-w-6xl mx-auto text-center">
          <Label>Implementação</Label>

          <h2 className="font-display text-[30px] font-medium tracking-tight">
            6 semanas até o lançamento
          </h2>
          <p className="text-[15px] text-navy-400 mt-3 max-w-md mx-auto font-light leading-relaxed">
            Entregas semanais com validação a cada etapa.
            Operação completa no ar em abril.
          </p>

          <div ref={refCrono} className="mt-14 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 reveal-children">
            {[
              ...
              <div key={w.s} className="flex gap-4 p-5 bg-white rounded-xl border border-navy-100 shadow-sm card-hover cursor-default">
                <span className="font-display text-[28px] font-medium text-navy-200 leading-none w-8 flex-shrink-0 transition-colors duration-300 group-hover:text-navy-400">
                  {w.s}
                </span>
                <div>
        ...
        <div ref={refDifs} className="grid grid-cols-1 md:grid-cols-3 gap-10 text-center reveal-children">
          {[
            ...
            <div key={d.t} className="group cursor-default">
              <div className="w-14 h-14 rounded-2xl bg-navy-50 border border-navy-100 flex items-center justify-center mx-auto mb-5 transition-all duration-400 group-hover:bg-navy-900 group-hover:border-navy-800 group-hover:shadow-lg group-hover:shadow-navy-900/15 group-hover:-translate-y-1">
                <d.icon size={24} className="text-navy-400 transition-colors duration-400 group-hover:text-white" strokeWidth={1.4} />
              </div>
      ...
      {/* ═══════ FOOTER ═══════ */}
      <footer className="py-14 px-8 border-t border-navy-100 text-center">
        <p className="font-display text-[17px] font-medium text-navy-800">Contabia</p>
        <p className="text-[12px] text-navy-300 mt-2">
          Proposta técnica — valores e prazos sob consulta
        </p>
      </footer>
    </div>
  );
